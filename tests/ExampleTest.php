...
use DIJ\Langfuse\Laravel\LangfuseManager;
...
it('returns a LangfuseManager instance from fake', function (): void {
    $manager = Langfuse::fake();

    expect($manager)->toBeInstanceOf(LangfuseManager::class);
});
